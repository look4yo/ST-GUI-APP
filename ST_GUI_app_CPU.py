...
MODEL_PATH = BASE_DIR / "TabPFN_CPU_ST_model.joblib"
PREPROCESSOR_PATH = BASE_DIR / "TabPFN_CPU_ST_preprocessor.joblib"

# 优先寻找 CPU 版 explainer；若没有，再尝试旧的 GPU 版 explainer
EXPLAINER_PATH_CPU = BASE_DIR / "shap_explainer_TabPFN_CPU_ST.joblib"
EXPLAINER_PATH_GPU = BASE_DIR / "shap_explainer_TabPFN_GPU_ST.joblib"
